...
<body class="sb-nav-fixed">
    ...
    <div id="layoutSidenav_content">
        <main>
            <div class="container-fluid px-4">
                <h1 class="mt-4">Soil Moisture</h1>
                <ol class="breadcrumb mb-4">
                    <li class="breadcrumb-item"><a href="index.php">Dashboard</a></li>
                    <li class="breadcrumb-item active">SoilMoisture</li>
                </ol>
                <div class="card mb-4">
                    <div class="card-body">
                        This dashboard uses line charts, pie charts, and bar charts to display Soil Moisture statistics for the given time period. Using datatable, you may view more information
                    </div>
                </div>
                <div class="card mb-4">
    ...
    <script>
        ...
        <?php foreach ($sensor_data as $row) {
            ...
            $humidity = (float)$row['Soil_Moisture'];
        ...
        new Chart("myChart", {
            ...
            options: {
                title: {
                    display: true,
                    text: "Latest Soil Moisture Comparison Chart"
                }
            }
        });
    </script>
