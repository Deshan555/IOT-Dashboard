    ...
    <div id="layoutSidenav_content">
        <main>
            <div class="container-fluid px-4">
                <h1 class="mt-4">Gas Value</h1>
                <ol class="breadcrumb mb-4">
                    <li class="breadcrumb-item"><a href="index.php">Dashboard</a></li>
                    <li class="breadcrumb-item active">GasValue</li>
                </ol>
                <div class="card mb-4">
                    <div class="card-body">
                        This dashboard uses line charts, pie charts, and bar charts to display Gas Value statistics for the given time period. Using datatable, you may view more information
                    </div>
                </div>
                <div class="card mb-4">
                            ...
                            <tbody>
                                <?php foreach ($all_data as $row) { ?>
                                    <tr>
                                        ...
                                        <td><?php echo $row['Gas_Value'] . ' PPM' ?></td>
                                    </tr>
                                <?php } ?>
                            </tbody>
                        </table>
    ...
    <script>
        ...
        new Chart("myChart", {
            ...
            options: {
                title: {
                    display: true,
                    text: "Latest Gas Value(PPM) Comparison Chart"
                }
            }
        });
    </script>
