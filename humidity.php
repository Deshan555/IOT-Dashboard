    ...
    <div id="layoutSidenav_content">
        <main>
            <div class="container-fluid px-4">
                ...
                <div class="card mb-4">
                    <div class="card-body">
                    This dashboard uses line charts, pie charts, and bar charts to display humidity statistics for the given time period. Using datatable, you may view more information
                    </div>
                </div>
                <div class="card mb-4">
    ...
    <script>
        ...
        new Chart("myChart", {
            ...
            options: {
                title: {
                    display: true,
                    text: "Latest Humidity(%) Comparison Chart"
                }
            }
        });
    </script>
